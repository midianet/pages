...
const Header: React.FC = () => {
    return (
        <div className="border-[0.5] shadow-md bg-white fixed w-full z-[100]">
            <nav className="bg-gradient-to-l from-slate-200  border-slate-800 py-2.5 dark:bg-gray-900">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" className="flex items-center">
                        <img src={logo} className="h-10 mr-2 sm:h-16" alt="Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">JUG</span>
                    </a>
                    {/* 
                        <div className="flex items-center lg:order-2">
                            <div className="hidden mt-2 mr-4 sm:inline-block">strokeWidth
