...
const Footer: React.FC = () => {
    return (
        <div className="bg-gray-50 dark:bg-gray-800 w-full p-2 ">
            <div className="text-center">
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 20??-2024 GOJava™. Todos os direitos reservados.
                </span>
